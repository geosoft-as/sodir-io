 ...
 *
 * @param <T>  The NPD instance type to read.
 *
...
public abstract class NpdReader<T>
{
   ...
   * @throws ParseException  If the tokens cannot be parsed into a NPD instance
   *                         of the correct type.
   */
  ...
  protected static Class<? extends NpdObject> parseClass(String text)
  {
    ...
    if (kind.startsWith("field"))
      return no.geosoft.npdio.field.NpdField.class;
