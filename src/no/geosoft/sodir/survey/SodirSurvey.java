package no.geosoft.sodir.survey;
...
/**
 * A survey as modeled by Sodir.
 * <p>
 * This class is thread-safe.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirSurvey extends SodirObject
{
   ...
   * </ul>
   * <p>
   * varchar(100), corresponds to Sodir property <em>seaStatus</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(255), corresponds to Sodir property <em>seaGeographicalArea</em>.
   *
   ...
   * <p>
   * varchar(100), corresponds to Sodir property <em>seaMidPoint</em>.
   *
   ...
   * <p>
   * varchar(100), corresponds to Sodir property <em>seaCategory</em>.
   *
   * @return  Category of this survey.
   */
   ...
   * <p>
   * varchar(100), corresponds to Sodir property <em>seaSurveyTypeMain</em>.
   *
   ...
   * <p>
   * varchar(100), corresponds to Sodir property <em>seaSurveyTypePart</em>.
   *
   ...
   * <p>
   * varchar(100), corresponds to Sodir property <em>seaCompanyReported</em>.
   *
   ...
   * The boats shown here are entered in  the message sent Sodir by the company
   * doing the survey.
   * <p>
   * varchar(1000), corresponds to Sodir property <em>seaVesselAll</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>seaPlanFromDate</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>seaPlanToDate</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>seaDateStarting</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>seaDateFinalized</em>.
   *
   ...
   * <p>
   * int, corresponds to Sodir property <em>seaPlanBoatKm</em>.
   *
   ...
   * Total planned acquistion length.
   * <p>
   * int, corresponds to Sodir property <em>seaPlanCdpKm</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Planned net area - calculated by Sodir map tool if 3D or 4D.
   * <p>
   * decimal, corresponds to Sodir property <em>sea3DKm2</em>.
   *
   ...
   * <p>
   * int, corresponds to Sodir property <em>seaSurveyAcquired</em>.
   *
   ...
   * <p>
   * varchar(20), corresponds to Sodir property <em>seaMarketAvailable</em>.
   *
   ...
   * <p>
   * varchar(20), corresponds to Sodir property <em>seaSampling</em>.
   *
   ...
   * <p>
   * varchar(20), corresponds to Sodir property <em>seaShallowDrilling</em>.
   *
   ...
   * <p>
   * varchar(20), corresponds to Sodir property <em>seaGeotechnical</em>.
   *
