...
/**
 * Common part of all wellbores as modeled by the Sodir.
 * Act as base class for the specific wellbore types.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public class SodirWellbore extends SodirObject
{
   ...
   * Official name of the parent well for the wellbore based on Sodir guidelines for
   * designation of wells and wellbores.
   * <p>
   * varchar(40), corresponds to Sodir property <em>wlbWell</em>.
   *
   ...
   * <p>
   * varchar(60), corresponds to Sodir property <em>wlbDrillingOperator</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbProductionLicence</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbStatus</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbPurpose</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbPurposePlanned</em>.
   *
   ...
   * </ul>
   * varchar(40), corresponds to the Sodir property <em>wlbContent</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(20), corresponds to the Sodir property <em>wlbWellType</em>.
   *
   ...
   * <p>
   * varchar(3), corresponds to the Sodir property <em>wlbSubSea</em>.
   *
   ...
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbEntryDate</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbField</em>.
   *
   ...
   * permit as stated in the drilling permit granted by the Sodir.
   * <p>
   * varchar(10), corresponds to the Sodir property <em>wlbDrillPermit</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbDiscovery</em>.
   *
   ...
   * <p>
   * varchar(3), corresponds to the Sodir property <em>wlbDiscoveryWellbore</em>.
   *
   ...
   * <p>
   * numeric, corresponds to the Sodir property <em>wlbKellyBushElevation</em>.
   *
   ...
   * <p>
   * real, corresponds to the Sodir property <em>wlbFinalVerticalDepth</em>.
   *
   ...
   * <p>
   * numeric, corresponds to the Sodir property <em>wlbTotalDepth</em>.
   *
   ...
   * <p>
   * numeric, corresponds to the Sodir property <em>wlbWaterDepth</em>.
   *
   ...
   * <p>
   * numeric, corresponds to the Sodir property <em>wlbKickOffPoint</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbMainArea</em>.
   *
   ...
   * <p>
   * Sodir's name of the facility which the wellbore was drilled from.
   * <p>
   * varchar(50), corresponds to the Sodir property <em>wlbDrillingFacility</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbFacilityTypeDrilling</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(10), corresponds to the Sodir property <em>wlbDrillingFacilityFixedOrMoveable</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbLicensingActivity</em>.
   *
   ...
   * See also Sodir guidelines for designation of wells and wellbores.
   * <p>
   * varchar(3), corresponds to the Sodir property <em>wlbMultilateral</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbEntryYear</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbCompletionYear</em>.
   *
   ...
   * not the other way.
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbReclassFromWellbore</em>.
   *
   ...
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbDateReclass</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Name of the site survey as reported to Sodir in system for reporting
   * site surveys, seismic and electromagnetic activities.
   * <p>
   * varchar(100), corresponds to Sodir property <em>wlbSiteSurvey</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * SodirID for the site survey.
   * <p>
   * int, corresponds to Sodir property <em>wlbNpdidSiteSurvey</em>.
   *
   * @return  Site survey of this wellbore. Null if N/A or unknown.
   */
   ...
   * Plugged and abandon date.
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbPluggedAbandonDate</em>.
   *
   ...
   * Plugged date.
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbPluggedDate</em>.
   *
   ...
   * Prod. license for drilling target.
   * <p>
   * varchar(10), corresponds to the Sodir property <em>wlbLicenseTargetName</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Sodir's plot symbol number for wellbores.
   * <p>
   * int, corresponds to the Sodir property <em>wlbPlotSymbol</em>.
   *
   ...
   * <p>
   * varchar(6), corresponds to the Sodir property <em>wlbGeodeticDatum</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbNsDeg</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbNsMin</em>.
   *
   ...
   * <p>
   * real, corresponds to the Sodir property <em>wlbNsSec</em>.
   *
   ...
   * <p>
   * varchar(1), corresponds to the Sodir property <em>wlbNsCode</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbEwDeg</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbEwMin</em>.
   *
   ...
   * <p>
   * real, corresponds to the Sodir property <em>wlbEwSec</em>.
   *
   ...
   * <p>
   * varchar(1), corresponds to the Sodir property <em>wlbEwCode</em>.
   *
   ...
   * <p>
   * decimal, corresponds to the Sodir property <em>wlbNsDecDeg</em>.
   *
   ...
   * <p>
   * decimal, corresponds to the Sodir property <em>wlbEwDesDeg</em>.
   *
   ...
   * <p>
   * decimal, corresponds to the Sodir property <em>wlbNsUtm</em>.
   *
   ...
   * <p>
   * decimal, corresponds to the Sodir property <em>wlbEwUtm</em>.
   *
   ...
   * <p>
   * int, corresponds to the Sodir property <em>wlbUtmZone</em>.
   *
   ...
   * Based on Sodir guidelines for designation of wells and wellbores.
   * <p>
   * int, corresponds to the Sodir property <em>wlbNamePart1</em>.
   *
   ...
   * Based on Sodir guidelines for designation of wells and wellbores.
   * <p>
   * int, corresponds to the Sodir property <em>wlbNamePart2</em>.
   *
   ...
   * Based on Sodir guidelines for designation of wells and wellbores.
   * <p>
   * varchar(1), corresponds to the Sodir property <em>wlbNamePart3</em>.
   *
   ...
   * Based on Sodir guidelines for designation of wells and wellbores.
   * <p>
   * int, corresponds to the Sodir property <em>wlbNamePart4</em>.
   *
   ...
   * Based on Sodir guidelines for designation of wells and wellbores.
   * <p>
   * varchar(2), corresponds to the Sodir property <em>wlbNamePart5</em>.
   *
   ...
   * Based on Sodir guidelines for designation of wells and wellbores.
   * <p>
   * varchar(2), corresponds to the Sodir property <em>wlbNamePart6</em>.
   *
   ...
   * <p>
   * varchar(20), corresponds to the Sodir property <em>wlbDiskosWellboreType</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to the Sodir property <em>wlbDiskosWellboreParent</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Sodir's unique id for the discovery.
   * <p>
   * bigint, corresponds to the Sodir property <em>dscNpdidDiscovery</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Sodir's unique id for the field.
   * <p>
   * bigint, corresponds to the Sodir property <em>fldNpdidField</em>.
   *
   ...
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbWdssQcDate</em>.
   *
   ...
   * relinquished.
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbReleasedDate</em>.
   *
   ...
   * <p>
   * Sodir's unique id for the production license the wellbore was drilled in.
   * <p>
   * bigint, corresponds to the Sodir property <em>prlNpdidProductionLicence</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Sodir's unique id for the facility that has drilled the wellbore.
   * <p>
   * bigint, corresponds to the Sodir property <em>fclNpdidFacilityDrilling</em>.
   *
   ...
   * <p>
   * <b>Sodir description:</b><br>
   * Sodir's unique id for the wellbore this wellbore was reclassified from.
   * <p>
   * bigint, corresponds to the Sodir property <em>wlbNpdidWellboreReclass</em>.
   *
   ...
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbDateUpdated</em>
   *
   ...
   * <p>
   * datetime, corresponds to the Sodir property <em>wlbDateUpdatedMax</em>
   *
