...
/**
 * Reader for Sodir development wellbores.
 * <p>
 * This class is thread-safe.

 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirDevelopmentWellboreReader extends SodirReader<SodirDevelopmentWellbore>
{
  /**
  ...
  /**
   * Create a reader for Sodir development wellbores.
   *
   * @param url  Location of file to read. Non-null.
   * @throws IllegalArgumentException  If url is null.
   */
  public SodirDevelopmentWellboreReader(String url)
  {
    super(url);
  }

  /**
   * Read all Sodir development wellbores.
   * <p>
   ...
   * <pre>
   *   SodirDevelopmentWellboreReader reader = new SodirDevelopmentWellboreReader(url);
   *   List&lt;SodirDevelopmentWellbore&gt; wellbores = reader.read();
   * </pre>
   *
   * @return  All Sodir development wellbores. Never null.
   * @throws IOException  If the read operation fail for some reason.
   */
  public static List<SodirDevelopmentWellbore> readAll()
    throws IOException
  {
    SodirDevelopmentWellboreReader reader = new SodirDevelopmentWellboreReader(DEVELOPMENT_WELLBORE_URL);
    return reader.read();
  }

  /** {@inheritDoc} */
  @Override
  protected SodirDevelopmentWellbore newInstance(String[] tokens)
  ...
  {
    try {
      List<SodirDevelopmentWellbore> wellbores = SodirDevelopmentWellboreReader.readAll();
      for (SodirDevelopmentWellbore wellbore : wellbores)
