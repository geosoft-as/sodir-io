...
/**
 * Reader for Sodir <em>other</em> wellbores.
 * <p>
 * This class is thread-safe.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirOtherWellboreReader extends SodirReader<SodirOtherWellbore>
{
  /**
  ...
  private static final int UPDATED_DATE_INDEX = 46;
  private static final int DATESYNC_NPD_INDEX = 47;

  /**
   * Create a reader for Sodir <em>other</em> wellbores.
   *
   * @param url  Location of file to read. Non-null.
   * @throws IllegalArgumentException  If url is null.
   */
  public SodirOtherWellboreReader(String url)
  {
    super(url);
  }

  /**
   * Read all Sodir <em>other</em> wellbores.
   * <p>
   ...
   * <pre>
   *   SodirOtherWellboreReader reader = new SodirOtherWellboreReader(url);
   *   List&lt;SodirOtherWellbore&gt; wellbores = reader.read();
   * </pre>
   *
   * @return  All Sodir other wellbores. Never null.
   * @throws IOException  If the read operation fail for some reason.
   */
  public static List<SodirOtherWellbore> readAll()
    throws IOException
  {
    SodirOtherWellboreReader reader = new SodirOtherWellboreReader(OTHER_WELLBORE_URL);
    return reader.read();
  }

  /** {@inheritDoc} */
  @Override
  protected SodirOtherWellbore newInstance(String[] tokens)
  ...
  {
    try {
      List<SodirOtherWellbore> wellbores = SodirOtherWellboreReader.readAll();
      for (SodirOtherWellbore wellbore : wellbores)
        if (wellbore.getAlias() != null)
