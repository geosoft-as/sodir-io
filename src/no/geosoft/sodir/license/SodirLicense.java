package no.geosoft.sodir.license;
...
/**
 * A <em>production license</em> as modeled by the Sodir.
 * <p>
 * This class is thread-safe.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirLicense extends SodirObject
{
   ...
   * <p>
   * varchar(40), corresponds to Sodir property <em>prlLicensingActivityName</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>prlMainArea</em>.
   *
   * @return Activity of this license. Null if N/A or unknown.
   */
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>prlStatus</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to Sodir property <em>prlStratigraphical</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>prlDateGranted</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>prlDateValidTo</em>.
   *
   ...
   * <p>
   * decimal, corresponds to Sodir property <em>prlOriginalArea</em>.
   *
   ...
   * <p>
   * decimal, corresponds to Sodir property <em>prlCurrentArea</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>prlPhaseCurrent</em>.
   *
