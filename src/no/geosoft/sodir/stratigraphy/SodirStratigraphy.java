...
/**
 * Stratigraphy as modeled by Sodir.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public class SodirStratigraphy
{
  ...
  /**
   * Create a Sodir stratigraphy instance
   */
  SodirStratigraphy(String wellboreName,
                    int topDepth,
                    int botDepth,
   ...
   * <p>
   * varchar(20), corresponds to Sodir property <em>lsuName</em>.
   *
   ...
   * <p>
   * varchar(9), corresponds to Sodir property <em>lsuLevel</em>
   *
   ...
   * <p>
   * <b>Sodir description</b><br>
   * Sodir's unique id for lithostratigraphic units.
   * <p>
   * int, corresponds to Sodir property <em>lsuNpdidLithoStrat</em>.
   *
