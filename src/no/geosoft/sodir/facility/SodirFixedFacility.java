...
/**
 * Fixed facility as modeled by the Sodir.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirFixedFacility extends SodirFacility
{
  private final String phase_;

  private final boolean isSurfaceFacility_;

  private final Class<? extends SodirObject> belongsToClass_;
  ...
  SodirFixedFacility(String npdId,
                     ...
                     Class<? extends SodirObject> belongsToClass,
                     String belongsToId,
                     Date startupDate,
  ...
  /**
   * Class of instance this facility belongs to, such as SodirField.class
   * etc.
   *
   * @return  Class of instance this facility belongs to. Null if none.
   */
  public Class<? extends SodirObject> getBelongsToClass()
  {
    return belongsToClass_;
  }

  /**
   * Sodir unique ID of instance this facility belongs to.
   *
   * @return  Sodir unique ID of instance this facility belongs to.
   *          Null if unknown.
   */
