package no.geosoft.sodir.discovery;
...
/**
 * A discovery as modeled by Sodir.
 * <p>
 * This class is thread-safe.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirDiscovery extends SodirObject
{
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>dscCurrentActivityStatus</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>dscHcType</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>nmaName</em>.
   *
   ...
   * Official field name.
   * <p>
   * varchar(40), corresponds to Sodir property <em>fldName</em>.
   *
   ...
   * <p>
   * datetime, corresponds to Sodir property <em>dscDateFromInclInField</em>.
   *
   ...
   * <p>
   * int, corresponds to Sodir property <em>dscDiscoveryYear</em>.
   *
   ...
   * <p>
   * varchar(40), corresponds to Sodir property <em>dscResInclInDiscoveryName</em>.
   *
   ...
   * </ul>
   * <p>
   * varchar(40), corresponds to Sodir property <em>dscOwnerKind</em>.
   *
   ...
   * Owner name.
   * <p>
   * varchar(40), corresponds to Sodir property <em>dscOwnerName</em>.
   *
