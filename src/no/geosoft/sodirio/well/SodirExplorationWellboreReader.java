...
/**
 * Reader for Sodir exploration wellbores.
 * <p>
 * This class is thread-safe.
 *
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a>
 */
public final class SodirExplorationWellboreReader extends SodirReader<SodirExplorationWellbore>
{
  /**
  ...
  private static final int ID_WELLBORE_INDEX = 77;
  private static final int ID_DISCOVERY_INDEX = 78;
  private static final int ID_FIELD_INDEX = 79;
  private static final int ID_FACILITY_DRILLING_INDEX = 80;
  private static final int ID_WELLBORE_RECLASS_INDEX = 81;
  private static final int ID_PRODUCTION_LICENSE_INDEX = 82;
  private static final int ID_SITE_SURVEY_INDEX = 83;
  ...
  /**
   * Create a reader for Sodir exploration wellbores.
   *
   * @param url  Location of file to read. Non-null.
   * @throws IllegalArgumentException  If url is null.
   */
  public SodirExplorationWellboreReader(String url)
  {
    super(url);
  }

  /**
   * Read all Sodir exploration wellbores.
   * <p>
   ...
   * <pre>
   *   SodirExplorationWellboreReader reader = new SodirExplorationWellboreReader(url);
   *   List&lt;SodirExplorationWellbore&gt; wellbores = reader.read();
   * </pre>
   *
   * @return  All Sodir exploration wellbores. Never null.
   * @throws IOException  If the read operation fail for some reason.
   */
  public static List<SodirExplorationWellbore> readAll()
    throws IOException
  {
    SodirExplorationWellboreReader reader = new SodirExplorationWellboreReader(EXPLORATION_WELLBORE_URL);
    return reader.read();
  }

  /** {@inheritDoc} */
  @Override
  protected SodirExplorationWellbore newInstance(String[] tokens)
    throws ParseException
  {
    ...
    SodirExplorationWellbore wellbore = new SodirExplorationWellbore(id,
                                                                     name,
                                                                     wellName,
                                                                     drillingOperator,
                                                                     productionLicense,
  ...
  {
    try {
      List<SodirExplorationWellbore> wellbores = SodirExplorationWellboreReader.readAll();
      for (SodirExplorationWellbore wellbore : wellbores)
