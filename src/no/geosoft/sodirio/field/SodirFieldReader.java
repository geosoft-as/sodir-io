...
public final class SodirFieldReader extends SodirReader<SodirField>
{
  ...
  private static final int ID_OWNER_INDEX = 10;
  private static final int ID_INDEX = 11;
  private static final int ID_DISCOVERY_WELLBORE_INDEX = 12;
  private static final int ID_OPERATOR_INDEX = 13;
    ...
    throws ParseException
  {
    ...
    String idOwner = tokens[ID_OWNER_INDEX];
    String idDiscoveryWellbore = tokens[ID_DISCOVERY_WELLBORE_INDEX];
